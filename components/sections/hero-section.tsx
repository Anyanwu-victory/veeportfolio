  ...
  return (
    <section id="home" className="min-h-screen
     relative overflow-hidden bg-background ">
      {/* Background Pattern */}
      <div className="absolute inset-0 dot-pattern opacity-50 max-w-full" />

      {/* Floating Elements */}
      <div className="absolute top-20 right-20 w-4 h-4 bg-primary/20 rounded-full animate-float" />
      <div
        className="absolute top-40 right-40 w-2 h-2 bg-primary/30 rounded-full animate-float"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute bottom-40 left-20 w-3 h-3 bg-primary/25 rounded-full animate-float"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen">
          ...
          >
            <div className="space-y-4">
              ...
              >
                HELLO, <span className="text-[#10b77f] font-semibold">MY NAME IS</span>
              </motion.p>
            ...
            >
              From Abuja, Nigeria. I have rich experience in web development, also I am good at writing. I love to talk with
            ...
            >
              <Button variant="ghost" size="icon" className="hover:text-[#10b77f]">
                <Link href=""> 
            ...
            >
              ...
              <Button variant="outline" size="lg" className="group font-italize text-shadow-color-border ">
                MY SKILLS
